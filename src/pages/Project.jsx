...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-white text-gray-900">
      {/* Sidebar */}
      <aside className="w-64 flex flex-col bg-white border-r border-gray-200 h-screen">
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-4">
          {sidebarLinks.map(({ icon: Icon, title, subtitle }) => (
            <a
              key={title}
              className="flex items-center space-x-3 hover:text-gray-900 cursor-pointer"
            >
        ...
        <div className="m-4 p-4 bg-white rounded-lg shadow">
          <div className="flex items-center space-x-3">
            <div className="w-11 h-11 bg-gradient-to-br from-purple-600 to-purple-400 rounded-full flex items-center justify-center text-white">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
            <p className="flex items-center text-green-600 gap-1">
              <BoltIcon className="w-4 h-4" /> Streak: 0
            </p>
            <p className="flex items-center text-orange-500 gap-1">
              <StarIcon className="w-4 h-4" /> Rating: 0
            </p>
            <p className="flex items-center text-blue-700 gap-1">
              <ChartBarIcon className="w-4 h-4" /> Projects: 0
            </p>
            <p className="flex items-center text-red-600 gap-1">
              <BoltIcon className="w-4 h-4" /> Bugs: 0
            </p>
          </div>
        </div>
      </aside>
